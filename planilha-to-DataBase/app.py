    ...
    if data != "Fail":
        ...
        while rows_processed < total_rows:
            ...
            for row in data_batch:
                ...
                cursor.execute(
                    "INSERT INTO exemplo (contrato_id, numero_proposta, usuario_digitacao_banco, data_inclucao, cpf_cliente, banco, convenio, prazo, valor_bruto, valor_liquido, valor_parcela, valor_base, comissao_empresa_vista_valor, comissao_repasse_valor, nome_corretor, status_banco_empresa, data_status_banco_empresa, sub_status_banco_empresa, status_banco_cliente , upload_id) VALUES (%s, %s, %s, TO_DATE(%s, 'DD-MM-YYYY'), %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,TO_DATE(%s, 'DD-MM-YYYY'), %s, %s, %s)",
                    values)
